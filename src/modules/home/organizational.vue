...
import userList from '@/modules/home/organizational_user.vue';
...
const tableEvent = {
  init: async function () {
    ...
    const apiData = await api.get(apiUrl.home.organizational.organ_init);
...
const getReportConfig = () => {
  return {
    dataFetcher: async (url, query) => {
      ...
      const {list, param} = await api.get( apiUrl.home.organizational.dept_list, query);
      table.param = param;
      return list;
    },
    menu: table.menu,
