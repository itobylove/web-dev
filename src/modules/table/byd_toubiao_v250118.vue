...
const sql=`create table if not exists table_byd_toubiao (
...
const _apiUrl=api.url.table.byd_toubiao;
const tableRef=ref();
//表格配置
const tableConfig = {
  options:{
    columns: [
      { field: 'customCode', title: '客户代码', width: 'auto', editor: 'input-editor'},
      { field: 'department', title: '事业部', width: 'auto', editor: 'input-editor'},
      { field: 'sourceOrderNo', title: '寻源单号', width: 'auto', editor: 'input-editor'},
      { field: 'projectName', title: '招标具体项目', width: 'auto', editor: 'input-editor'},
      { field: 'competition', title: '竞争类型', width: 'auto', editor:"list-editor-competition",fieldOptions:['','大竞争','事业部内竞争']},
      { field: 'custMatCode', title: '客户物料号码', width: 'auto', editor: 'input-editor',style:{bgColor:'#FF9999'}},
      { field: 'partName', title: '客户料号', width: 'auto', editor: 'input-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'partNumRev', title: '我司型号', width: 'auto', editor: 'input-editor',style:{bgColor:'#CCFFCC'}},
      ...
      { field: 'material', title: '板材类型', width: 'auto', editor: 'input-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'cost', title: '成本', width: 'auto', editor: 'number-editor'},
      { field: 'length', title: 'SET长', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'width', title: 'SET宽', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'punch', title: '拼板数', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'bidQuantity', title: '标的数量', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'plateArea', title: '标的平米数', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'bidPrice', title: '投标未税平米价', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'bidUnitPrice', title: '投标未税单价', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'bidTotalAmount', title: '标的总金额', width: 'auto', editor: 'number-editor',style:{bgColor:'#CCFFCC'}},
      { field: 'bidStatus', title: '中标情况', width: 'auto', editor: 'input-editor'},
      { field: 'bidShare', title: '中标份额', width: 'auto', editor: 'input-editor'},
      { field: 'bidTotalAmount2', title: '中标总金额', width: 'auto', editor: 'number-editor'},
      { field: 'competitorBidPrice', title: '友商中标价格', width: 'auto', editor: 'number-editor'},
      { field: 'bidDeadline', title: '投标截止时间', width: 'auto', editor: 'date-editor'},
      { field: 'priceValidityEndDate', title: '价格有效终止日期', width: 'auto', editor: 'date-editor'},
      { field: 'sampleTime', title: '打样时间', width: 'auto', editor: 'date-editor'},
      { field: 'sampleNo', title: '打样编号', width: 'auto', editor: 'input-editor'},
      { field: 'deliveryTime', title: '交样时间', width: 'auto', editor: 'date-editor'},
      { field: 'isBatch', title: '是否批量', width: 'auto', editor: 'input-editor'},
      { field: 'batchQuantity', title: '批量数量', width: 'auto', editor: 'number-editor'},
      { field: 'batchArea', title: '批量面积', width: 'auto', editor: 'number-editor'},
      { field: 'batchAmount', title: '批量金额', width: 'auto', editor: 'number-editor'},
      /*{ field: 'projectStartTime', title: '项目启动时间', width: 'auto', editor: 'date-editor'},
      { field: 'OTSReleaseTime', title: 'OTS发布时间', width: 'auto', editor: 'date-editor'},
      { field: 'OTSDeadline', title: 'OTS截止时间', width: 'auto', editor: 'date-editor'},
      { field: 'OTSStatus', title: 'OTS状态', width: 'auto', editor:'list-editor-OTSStatus',fieldOptions:['','驳回整改','待会签','待提交','结案','审核中','已结案','整改中','终止']},
      { field: 'PPAPReleaseTime', title: 'PPAP发布时间', width: 'auto', editor: 'date-editor'},
      { field: 'PPAPDeadline', title: 'PPAP截止时间', width: 'auto', editor: 'date-editor'},
      { field: 'PPAPStatus', title: 'PPAP状态', width: 'auto', editor: 'list-editor-PPAPStatus',fieldOptions:['','已完成']},*/
    ],
    menu: {
      contextMenuItems: [
